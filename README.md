...
#### Ideas
- shooting continously (with cooldwon tho), also limited amo (switch to slow pistol if out of amo)
...
- If a enemy is killed, theres a chance to drop items? speed boost, fire power, lives(make sure that those dont count to punktestand), invisibility for 5 sec?
...
- MUSIC, different themes (boss, regular, lost lives, shots dying opponents, game over, victory)
- Minecraft ideas: traps, web to get stuck in, creeper opponents/bombs,...
